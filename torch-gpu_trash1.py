...
if __name__ == '__main__':
    ...
    for rihibgfd in range(0, 1) :
        ...
        optimizer2 = torch.optim.Adam(net_sae_net.parameters(), lr=0.0001)  # 传入 net 的所有参数, 学习率
        ...
        for epoch in range(4000):   # NET_SAE_NET
            ...
            for (batch_x, batch_y) in loader:
                ...
                loss2 = loss_func2(prediction,torch.max(b_y, 1)[0])*2
