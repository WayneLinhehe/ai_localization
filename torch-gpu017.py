...
from train_data_all import get_train_data_cla_qua
    ...
    for rihibgfd in range(0, 1) :
        ...
        for step_right in range( 0, len(data6) ) :
            ...
            if ( ( step_right != len(data6)-1 ) and vv == data6[step_right][3] ) :
                ...
                ran3 = random.randint( step_left , kc )
                ran4 = random.randint( step_left , kc )
                
                for i in range( step_left, step_right ) :
                    if ( i == ran1 or i == ran2 or i == ran3 or i == ran4 ) :
        ...
        net_sae_net = torch.nn.Sequential(
            ...
            torch.nn.ReLU(),
            torch.nn.Linear(1024, 20, bias=True),
            torch.nn.Softmax(), 
        )
